...
* @returns {any}
*/
module.exports.parse_js = function(data) {
    const ret = wasm.parse_js(addHeapObject(data));
...
module.exports.__wbg_log_1b4547c43d6ca35b = function(arg0, arg1) {
...
const path = require('path').join(__dirname, 'does_it_throw_wasm_bg.wasm');
